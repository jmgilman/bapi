...
def test_balance():
    ...
    expected = {
        "Assets:US:Babble:Vacation": {"VACHR": {"number": -2, "currency": "VACHR"}},
        "Assets:US:BofA:Checking": {"USD": {"number": 2035.9, "currency": "USD"}},
        "Assets:US:ETrade:Cash": {"USD": {"number": 444.51, "currency": "USD"}},
        ...
        "Assets:US:Vanguard:Cash": {"USD": {"number": -0.01, "currency": "USD"}},
        "Assets:US:Vanguard:RGAGX": {"RGAGX": {"number": 225.174, "currency": "RGAGX"}},
        "Assets:US:Vanguard:VBMPX": {"VBMPX": {"number": 121.559, "currency": "VBMPX"}},
        "Equity:Opening-Balances": {"USD": {"number": -2845.77, "currency": "USD"}},
        "Expenses:Financial:Commissions": {"USD": {"number": 232.7, "currency": "USD"}},
        "Expenses:Financial:Fees": {"USD": {"number": 100.0, "currency": "USD"}},
        "Expenses:Food:Alcohol": {"USD": {"number": 79.42, "currency": "USD"}},
        "Expenses:Food:Coffee": {"USD": {"number": 116.17, "currency": "USD"}},
        "Expenses:Food:Groceries": {"USD": {"number": 4730.77, "currency": "USD"}},
        "Expenses:Food:Restaurant": {"USD": {"number": 8822.2, "currency": "USD"}},
        ...
        "Expenses:Home:Electricity": {"USD": {"number": 1560.0, "currency": "USD"}},
        "Expenses:Home:Internet": {"USD": {"number": 1920.07, "currency": "USD"}},
        ...
        "Expenses:Taxes:Y2020:US:SDI": {"USD": {"number": 30.24, "currency": "USD"}},
        ...
        "Expenses:Taxes:Y2021:US:SDI": {"USD": {"number": 29.12, "currency": "USD"}},
        ...
        "Expenses:Taxes:Y2022:US:SDI": {"USD": {"number": 1.12, "currency": "USD"}},
        "Expenses:Taxes:Y2022:US:SocSec": {
            "USD": {"number": 281.54, "currency": "USD"}
        },
        "Expenses:Taxes:Y2022:US:State": {"USD": {"number": 365.08, "currency": "USD"}},
        "Expenses:Transport:Tram": {"USD": {"number": 2760.0, "currency": "USD"}},
        "Expenses:Vacation": {"VACHR": {"number": 272, "currency": "VACHR"}},
        "Income:US:Babble:GroupTermLife": {
            "USD": {"number": -1313.28, "currency": "USD"}
        },
        "Income:US:Babble:Match401k": {"USD": {"number": -19100.0, "currency": "USD"}},
        "Income:US:Babble:Salary": {"USD": {"number": -249230.52, "currency": "USD"}},
        "Income:US:Babble:Vacation": {"VACHR": {"number": -270, "currency": "VACHR"}},
        "Income:US:ETrade:GLD:Dividend": {},
        "Income:US:ETrade:ITOT:Dividend": {},
        "Income:US:ETrade:PnL": {"USD": {"number": -295.85, "currency": "USD"}},
        ...
        "Liabilities:US:Chase:Slate": {"USD": {"number": -2444.36, "currency": "USD"}},
    }
